export default ({ object, total = 0, repeat = 0, alternate = false, direction = true, autoplay = true, delay = 0, duration = 1000, ease = (x) => (x < 0.5 ? 4 * x ** 3 : 1 - 0.5 * (-2 * x + 2) ** 3), round = 0, begin, update, iterate, complete, ...extra }) => {
    const initial = {
        ...object
    };
    const final = {
